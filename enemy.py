...
class Enemy(pygame.sprite.Sprite):
    ...
    def update(self, surface, target, bullet_group):
        if self.alive:
            ...
            if self.action == 1:
                ...
                if pygame.time.get_ticks() - self.last_attack > self.attack_cooldown:
                    ...
                    self.last_attack = pygame.time.get_ticks()  # resets timer again
        ...
        surface.blit(self.image, (self.rect.x - 20, self.rect.y - 25))

    def update_animation(self):
        # define animation cooldown
        animation_cooldown = 50  # this is 0.5 seconds
